...
Dataset used:  UCSD Ped1 surveillance dataset, where normal training videos contain only pedestrians, and test videos include anomalies such as bicycles, cars, or unusual motions<br>
